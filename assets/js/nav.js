...
(() => {
  ...
  logoStyle.textContent = `
    ...
    #cs-navigation .cs-logo .cs-default {
      transform: translate(-1.5%, -30%) !important;
    }

    #cs-navigation .cs-logo .cs-onscroll {
      transform: translate(-1.5%, -30%) rotateX(180deg) !important;
    }
    ...
    body.dark-mode #cs-navigation .cs-logo .cs-onscroll {
      transform: translate(-1.5%, -30%) rotateX(0deg) !important;
  ...
  document.querySelectorAll('#cs-navigation .cs-logo img').forEach((logo) => {
    logo.src = logoSrc;
